...
def solve(instance: Dict[str, Any], parameters: Dict[str, Any]) -> Dict[str, Any]:
    ...
    max_inventory = int(instance['max_inventory'])
    min_closing_inventory = int(instance['min_closing_inventory'])
    min_run_days = int(instance['min_run_days'])
    max_run_days = int(instance['max_run_days'])
